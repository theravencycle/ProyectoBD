...
def create_usuario():
	...
	user = Usuario.create(json['nombre'],json['apellido'],json['correo'],json['contrasenna'],json['pais'])
...
def update_usuario(id):
	...
	if json.get('nombre') is None or json.get('apellido') is None or json.get('correo') is None or json.get('contrasenna') is None or json.get('pais') is None :
...
@app.route('/api/v1/pais/<id>', methods=['GET'])
def get_pais(id):
...
@app.route('/api/v1/usuario_tiene_moneda/<id>', methods=['GET'])
def get_usuario_tiene_moneda(id):
...
@app.route('/api/v1/usuario_tiene_moneda/<id>', methods=['PUT'])
...
@app.route('/api/v1/usuario_tiene_moneda/<id>', methods=['DELETE'])
...
@app.route('/api/v1/precio_moneda/<id>', methods=['GET'])
def get_precio_moneda(id):
